...
- Each finding MUST include `verbatim_line` — an exact quote (>= 10 chars) from the diff being reviewed
- Findings without a verifiable verbatim quote are invalid and will be dropped
