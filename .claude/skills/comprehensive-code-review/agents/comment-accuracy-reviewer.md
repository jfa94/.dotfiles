...
EVERY FINDING MUST QUOTE BOTH (1) THE INACCURATE COMMENT (file:line + verbatim) AND (2) THE CONTRADICTING CODE (file:line + verbatim).

For each comment accuracy finding:

- Quote the comment (file:line + verbatim text), AND
- Quote the code line that contradicts or makes it stale (file:line + verbatim text).
...
- Location: [file:line] — comment verbatim quote
- Contradiction: [file:line] — code verbatim quote
