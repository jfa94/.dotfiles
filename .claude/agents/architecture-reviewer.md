...
6. **Circular dependency check**: `npx madge --circular --extensions ts,tsx src/ 2>&1` -- detects cycles
...
13. Check for:
    ...
    - Hallucinated packages -- if a new dependency is added, verify it exists: `npm view <package> version 2>&1`
